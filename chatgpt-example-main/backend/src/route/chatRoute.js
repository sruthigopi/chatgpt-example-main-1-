...
// earlier there is issue in retreving environment variable.
//  file name .env.example changed to .env
...
router.post('/', async (req, res) => {
  ...
  // for integrating openai this is enough and it is working, 
  // you may try diferent model offered by openai for any other required functionalities
